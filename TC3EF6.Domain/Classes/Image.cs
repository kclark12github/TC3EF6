...
{
    [DataContract, Table("Images"), TableDescription("Collection of Images both independent and those representing items tracked in the database.")]
    public class Image : DataEntityBase
    {
        ...
        [DataMember, StringLength(256), ColumnDescription("Image Name.")]
        public string Name
        {
            get => mName;
        ...
        [DataMember, ColumnDescription("Actual Image binary."),
        ...
        [DataMember, StringLength(80), ColumnDescription("File system object from which this Image was imported.")]
        ...
        [DataMember, StringLength(132), ColumnDescription("Internal web site providing this Image (if applicable).")]
        public string URL
        {
            get => mURL;
        ...
        [DataMember, ColumnDescription("Height in pixels of this Image.")]
        public int? Height
        {
            get => mHeight;
        ...
        [DataMember, ColumnDescription("Width in pixels of this Image.")]
        public int? Width
        {
            get => mWidth;
        ...
        [DataMember, StringLength(80), ColumnDescription("Category of this Image.")]
        ...
        [DataMember, StringLength(256), ColumnDescription("Sort string.")]
        ...
        [DataMember, StringLength(32), ColumnDescription("Table of the record related to this image."),
        ...
        [DataMember, ColumnDescription("Record ID of the record related to this image."),
        ...
        [DataMember, ColumnDescription("Does this image represent the thumbnail of another, main image?")]
        ...
        [DataMember, ColumnDescription("Thumbnail Image of this main image."),
        ...
        [DataMember, ColumnDescription("Image Caption.")]
