...
namespace TC3EF6.Data.CustomMigrationOperations
{
    public static class CustomSeed
    {
        ...
        private static void SeedLocations(TCContext context)
        {
            ...
            /* The following query does a pretty good job of teasing apart location descriptions and physical locations from the [Location] field...
                Select Distinct
                 'new Location { ID = Guid.NewGuid(), ' +
                    'Name = ' + IsNull('@"' +
                        RTRIM(
                            Case
                                When CHARINDEX('(',[tcLocations].[Location], 1) > 0 And CHARINDEX('[',[tcLocations].[Location], 1) > 0 Then
                                    Case
                                        When CHARINDEX('(',[tcLocations].[Location], 1) > 0 And CHARINDEX('(',[tcLocations].[Location], 1) < CHARINDEX('[',[tcLocations].[Location], 1) Then SUBSTRING([tcLocations].[Location], 1, CHARINDEX('(',[tcLocations].[Location], 1) - 1)
                                        When CHARINDEX('[',[tcLocations].[Location], 1) > 0 And CHARINDEX('[',[tcLocations].[Location], 1) < CHARINDEX('(',[tcLocations].[Location], 1) Then SUBSTRING([tcLocations].[Location], 1, CHARINDEX('[',[tcLocations].[Location], 1) - 1)
                                        Else[tcLocations].[Location]
                                    End
                                When CHARINDEX('(',[tcLocations].[Location], 1) > 0 Then SUBSTRING([tcLocations].[Location],1,CHARINDEX('(',[tcLocations].[Location], 1) - 1)
            				    When CHARINDEX('[',[tcLocations].[Location],1) > 0 Then SUBSTRING([tcLocations].[Location],1,CHARINDEX('[',[tcLocations].[Location], 1) - 1)
            				    Else[tcLocations].[Location]
                            End
            		    ) +'"', '""') +', ' +
                   'Description = ' + IsNull('@"' +
                       Case
                           When[tcLocations].[Location] Like '%(%)%' Then SUBSTRING([tcLocations].[Location], CHARINDEX('(',[tcLocations].[Location], 1) + 1, CHARINDEX(')',[tcLocations].[Location], 1) - CHARINDEX('(',[tcLocations].[Location], 1) - 1)
                            Else ''
                        End + '"', '""') +', ' +
                    'PhysicalLocation = ' + IsNull('@"' +
                        Case
                            When[tcLocations].[Location] Like '%![%!]%' Escape '!' Then SUBSTRING([tcLocations].[Location], CHARINDEX('[',[tcLocations].[Location], 1) + 1, CHARINDEX(']',[tcLocations].[Location], 1) - CHARINDEX('[',[tcLocations].[Location], 1) - 1)
                            Else ''
                        End + '"', '""') +', ' +
            ...
            */
            context.Locations.AddOrUpdate(x => x.Name,
                ...
                new Location { ID = Guid.NewGuid(), Name = @"\\Delta\Public\Shared TV\Reality", Description = @"", PhysicalLocation = @"", OName = @"\\Delta\Public\Shared TV\Reality" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Echo\Public\Shared Movies\Adventure", Description = @"", PhysicalLocation = @"", OName = @"\\Echo\Public\Shared Movies\Adventure" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Echo\Public\Shared Movies\Christmas", Description = @"", PhysicalLocation = @"", OName = @"\\Echo\Public\Shared Movies\Christmas" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"\\Echo\Public\Shared TV\Reality", Description = @"", PhysicalLocation = @"", OName = @"\\Echo\Public\Shared TV\Reality" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Foxtrot\Public\Shared Movies\Horror", Description = @"", PhysicalLocation = @"", OName = @"\\Foxtrot\Public\Shared Movies\Horror" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Foxtrot\Public\Shared Movies\Science Fiction", Description = @"", PhysicalLocation = @"", OName = @"\\Foxtrot\Public\Shared Movies\Science Fiction" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Foxtrot\Public\Shared TV\Documentary", Description = @"", PhysicalLocation = @"", OName = @"\\Foxtrot\Public\Shared TV\Documentary" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"\\Foxtrot\Public\Shared TV\War", Description = @"", PhysicalLocation = @"", OName = @"\\Foxtrot\Public\Shared TV\War" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"\\Foxtrot\Public\Shared\Videos\Music Videos", Description = @"", PhysicalLocation = @"", OName = @"\\Foxtrot\Public\Shared\Videos\Music Videos" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Golf\Public\Shared TV\Animation", Description = @"", PhysicalLocation = @"", OName = @"\\Golf\Public\Shared TV\Animation" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Golf\Public\Shared TV\Documentary", Description = @"", PhysicalLocation = @"", OName = @"\\Golf\Public\Shared TV\Documentary" },
                new Location { ID = Guid.NewGuid(), Name = @"\\Golf\Public\Shared TV\Western", Description = @"", PhysicalLocation = @"", OName = @"\\Golf\Public\Shared TV\Western" },
                new Location { ID = Guid.NewGuid(), Name = @"Amazon Prime Video", Description = @"", PhysicalLocation = @"", OName = @"Amazon Prime Video" },
                new Location { ID = Guid.NewGuid(), Name = @"Amazon Prime", Description = @"", PhysicalLocation = @"", OName = @"Amazon Prime" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea - Allies Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea - Allies Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea - Axis Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea - Axis Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea Condition Zebra Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea Condition Zebra Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea Flank Speed Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea Flank Speed Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea Fleet Command Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea Fleet Command Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea Surface Action Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea Surface Action Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea Task Force - Allies Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea Task Force - Allies Case" },
                new Location { ID = Guid.NewGuid(), Name = @"Axis&Allies War at Sea Task Force - Axis Case", Description = @"", PhysicalLocation = @"", OName = @"Axis&Allies War at Sea Task Force - Axis Case" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Bedroom", Description = @"", PhysicalLocation = @"", OName = @"Bedroom" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase #1", Description = @"Atop", PhysicalLocation = @"Carol's Room - East Wall", OName = @"Bookcase #1 (Atop) [Carol's Room - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase #1", Description = @"Second Shelf Shelf", PhysicalLocation = @"Carol's Room - East Wall", OName = @"Bookcase #1 (Second Shelf Shelf) [Carol's Room - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase #1", Description = @"Third Shelf Shelf", PhysicalLocation = @"Carol's Room - East Wall", OName = @"Bookcase #1 (Third Shelf Shelf) [Carol's Room - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase #1", Description = @"Top Shelf", PhysicalLocation = @"Carol's Room - East Wall", OName = @"Bookcase #1 (Top Shelf) [Carol's Room - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase A", Description = @"Bottom Shelf", PhysicalLocation = @"Ken's Room - West Wall By Door", OName = @"Bookcase A (Bottom Shelf) [Ken's Room - West Wall By Door]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase A", Description = @"Second Shelf", PhysicalLocation = @"Ken's Room - West Wall By Door", OName = @"Bookcase A (Second Shelf) [Ken's Room - West Wall By Door]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase A", Description = @"Third Shelf", PhysicalLocation = @"Ken's Room - West Wall By Door", OName = @"Bookcase A (Third Shelf) [Ken's Room - West Wall By Door]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase A", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - West Wall By Door", OName = @"Bookcase A (Top Shelf) [Ken's Room - West Wall By Door]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase B", Description = @"Bottom Shelf", PhysicalLocation = @"Ken's Room - West Wall Back", OName = @"Bookcase B (Bottom Shelf) [Ken's Room - West Wall Back]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase B", Description = @"Second Shelf", PhysicalLocation = @"Ken's Room - West Wall Back", OName = @"Bookcase B (Second Shelf) [Ken's Room - West Wall Back]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase B", Description = @"Third Shelf", PhysicalLocation = @"Ken's Room - West Wall Back", OName = @"Bookcase B (Third Shelf) [Ken's Room - West Wall Back]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase B", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - West Wall Back", OName = @"Bookcase B (Top Shelf) [Ken's Room - West Wall Back]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase C", Description = @"Bottom Shelf", PhysicalLocation = @"Ken's Room - West Wall By Closet", OName = @"Bookcase C (Bottom Shelf) [Ken's Room - West Wall By Closet]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase C", Description = @"Second Shelf", PhysicalLocation = @"Ken's Room - West Wall By Closet", OName = @"Bookcase C (Second Shelf) [Ken's Room - West Wall By Closet]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase C", Description = @"Third Shelf", PhysicalLocation = @"Ken's Room - West Wall By Closet", OName = @"Bookcase C (Third Shelf) [Ken's Room - West Wall By Closet]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase C", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - West Wall By Closet", OName = @"Bookcase C (Top Shelf) [Ken's Room - West Wall By Closet]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase F", Description = @"Second Shelf", PhysicalLocation = @"Ken's Room - Front Wall", OName = @"Bookcase F (Second Shelf) [Ken's Room - Front Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookcase F", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - Front Wall", OName = @"Bookcase F (Top Shelf) [Ken's Room - Front Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookshelf", Description = @"", PhysicalLocation = @"", OName = @"Bookshelf" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookshelf", Description = @"Bottom Shelf", PhysicalLocation = @"Ken's Room - Back Wall", OName = @"Bookshelf (Bottom Shelf) [Ken's Room - Back Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookshelf", Description = @"Bottom Shelf", PhysicalLocation = @"Ken's Room - East Wall", OName = @"Bookshelf (Bottom Shelf) [Ken's Room - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookshelf", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - Back Wall", OName = @"Bookshelf (Top Shelf) [Ken's Room - Back Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Bookshelf", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - East Wall", OName = @"Bookshelf (Top Shelf) [Ken's Room - East Wall]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Box #72-15", Description = @"UHM", PhysicalLocation = @"Basement", OName = @"Box #72-15 (UHM) [Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Box #72-5 Ziploc bag", Description = @"2nd set, with wheels, left in box", PhysicalLocation = @"", OName = @"Box #72-5 Ziploc bag (2nd set, with wheels, left in box)" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"CD Box #3", Description = @"ESSS", PhysicalLocation = @"Ken's Room", OName = @"CD Box #3 (ESSS) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"CD Box #4", Description = @"ESSS", PhysicalLocation = @"Ken's Room", OName = @"CD Box #4 (ESSS) [Ken's Room]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"CD Rack - Bottom Shelf", Description = @"", PhysicalLocation = @"Ken's Room", OName = @"CD Rack - Bottom Shelf [Ken's Room]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"CD Rack - Strategy", Description = @"C&C", PhysicalLocation = @"Ken's Room", OName = @"CD Rack - Strategy (C&C) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"CD Rack - Strategy", Description = @"Civilization", PhysicalLocation = @"Ken's Room", OName = @"CD Rack - Strategy (Civilization) [Ken's Room]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Coin Tote", Description = @"", PhysicalLocation = @"Bedroom", OName = @"Coin Tote [Bedroom]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Decals Binder", Description = @"Aircraft", PhysicalLocation = @"", OName = @"Decals Binder (Aircraft)" },
                new Location { ID = Guid.NewGuid(), Name = @"Decals Binder", Description = @"Naval", PhysicalLocation = @"", OName = @"Decals Binder (Naval)" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #02 - Waiting for WMV", Description = @"UHS", PhysicalLocation = @"Attic", OName = @"DVD Box #02 - Waiting for WMV (UHS) [Attic]" },
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #02", Description = @"UHS", PhysicalLocation = @"Attic", OName = @"DVD Box #02 (UHS) [Attic]" },
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #03 - Waiting for WMV", Description = @"UHS", PhysicalLocation = @"Attic", OName = @"DVD Box #03 - Waiting for WMV (UHS) [Attic]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #07", Description = @"", PhysicalLocation = @"UHS Basement", OName = @"DVD Box #07 [UHS Basement]" },
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #08", Description = @"", PhysicalLocation = @"UHS Basement", OName = @"DVD Box #08 [UHS Basement]" },
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #09", Description = @"", PhysicalLocation = @"UHS Basement", OName = @"DVD Box #09 [UHS Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #20 - Waiting for WMV", Description = @"33250", PhysicalLocation = @"Ken's Room", OName = @"DVD Box #20 - Waiting for WMV (33250) [Ken's Room]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #23", Description = @"33250", PhysicalLocation = @"Basement", OName = @"DVD Box #23 (33250) [Basement]" },
                new Location { ID = Guid.NewGuid(), Name = @"DVD Box #24", Description = @"33250", PhysicalLocation = @"Basement", OName = @"DVD Box #24 (33250) [Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"DVDs - General Box #2", Description = @"", PhysicalLocation = @"UHS Basement", OName = @"DVDs - General Box #2 [UHS Basement]" },
                new Location { ID = Guid.NewGuid(), Name = @"DVDs - General", Description = @"", PhysicalLocation = @"UHS Basement", OName = @"DVDs - General [UHS Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #1", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #1 [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #2", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #2 [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #3", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #3 [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #4", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #4 [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #5", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #5 [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #6", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #6 [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"FreeTime Box #7", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"FreeTime Box #7 [Basement - East Wall]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #03", Description = @"ESSS", PhysicalLocation = @"Attic", OName = @"Hot Wheels Box #03 (ESSS) [Attic]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #04", Description = @"ESSS", PhysicalLocation = @"Ken's Room", OName = @"Hot Wheels Box #04 (ESSS) [Ken's Room]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #35", Description = @"12x10x8.5", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Box #35 (12x10x8.5) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #36", Description = @"14x10x6.5", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Box #36 (14x10x6.5) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #37", Description = @"12x8.5x6.5", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Box #37 (12x8.5x6.5) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #38", Description = @"Unmarked 14x8x6", PhysicalLocation = @"Ken's Room", OName = @"Hot Wheels Box #38 (Unmarked 14x8x6) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #39", Description = @"Unmarked 20x14x6", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Box #39 (Unmarked 20x14x6) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #40", Description = @"Unmarked 16x12x8", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Box #40 (Unmarked 16x12x8) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Box #41", Description = @"Amazon Z12", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Box #41 (Amazon Z12) [Basement - East Wall]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Redlines Box #00", Description = @"Unmarked 10x7x2", PhysicalLocation = @"Basement - East Wall", OName = @"Hot Wheels Redlines Box #00 (Unmarked 10x7x2) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Hot Wheels Redlines Box #01", Description = @"HLJ 14x9x4.5", PhysicalLocation = @"Basement", OName = @"Hot Wheels Redlines Box #01 (HLJ 14x9x4.5) [Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Inside E-2C Hawkeye Box", Description = @"Revell 03945 Kit #2640", PhysicalLocation = @"", OName = @"Inside E-2C Hawkeye Box (Revell 03945 Kit #2640)" },
                new Location { ID = Guid.NewGuid(), Name = @"Inside Kit Box", Description = @"", PhysicalLocation = @"", OName = @"Inside Kit Box" },
                new Location { ID = Guid.NewGuid(), Name = @"Inside Kit Box", Description = @"Revell 03945 Kit #2640", PhysicalLocation = @"", OName = @"Inside Kit Box (Revell 03945 Kit #2640)" },
                new Location { ID = Guid.NewGuid(), Name = @"Inside Kit Box", Description = @"Revell 04882 Kit #2619", PhysicalLocation = @"", OName = @"Inside Kit Box (Revell 04882 Kit #2619)" },
                new Location { ID = Guid.NewGuid(), Name = @"Inside Kit Box", Description = @"Trumpeter 05711 Kit #2731", PhysicalLocation = @"", OName = @"Inside Kit Box (Trumpeter 05711 Kit #2731)" },
                new Location { ID = Guid.NewGuid(), Name = @"Inside Kit Box", Description = @"Trumpeter 05712 Kit #2732", PhysicalLocation = @"", OName = @"Inside Kit Box (Trumpeter 05712 Kit #2732)" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Ken's Hallmark Ornaments Box #1", Description = @"UHS", PhysicalLocation = @"Ken's Room", OName = @"Ken's Hallmark Ornaments Box #1 (UHS) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Ken's Hallmark Ornaments Box #2", Description = @"Unmarked 20x14x6", PhysicalLocation = @"Basement - East Wall", OName = @"Ken's Hallmark Ornaments Box #2 (Unmarked 20x14x6) [Basement - East Wall]" },
                new Location { ID = Guid.NewGuid(), Name = @"Ken's Room", Description = @"", PhysicalLocation = @"", OName = @"Ken's Room" },
                new Location { ID = Guid.NewGuid(), Name = @"Ken's Room", Description = @"East Wall", PhysicalLocation = @"", OName = @"Ken's Room (East Wall)" },
                new Location { ID = Guid.NewGuid(), Name = @"Ken's Room", Description = @"Front of Closet", PhysicalLocation = @"", OName = @"Ken's Room (Front of Closet)" },
                new Location { ID = Guid.NewGuid(), Name = @"Ken's Room", Description = @"Near Front Wall", PhysicalLocation = @"", OName = @"Ken's Room (Near Front Wall)" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Matchbox 60th Box", Description = @"", PhysicalLocation = @"Basement - East Wall", OName = @"Matchbox 60th Box [Basement - East Wall]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Micro Machines - Titanium  Series Box #01", Description = @"ESSS", PhysicalLocation = @"Attic", OName = @"Micro Machines - Titanium  Series Box #01 (ESSS) [Attic]" },
                new Location { ID = Guid.NewGuid(), Name = @"Micro Machines - Titanium  Series Box #02", Description = @"ESSS", PhysicalLocation = @"Attic", OName = @"Micro Machines - Titanium  Series Box #02 (ESSS) [Attic]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Micro Machines - Titanium  Series Box #04", Description = @"ESSS", PhysicalLocation = @"Attic", OName = @"Micro Machines - Titanium  Series Box #04 (ESSS) [Attic]" },
                new Location { ID = Guid.NewGuid(), Name = @"Micro Machines - Titanium  Series Box #05", Description = @"ESSS", PhysicalLocation = @"Attic", OName = @"Micro Machines - Titanium  Series Box #05 (ESSS) [Attic]" },
                new Location { ID = Guid.NewGuid(), Name = @"Micro Machines - Titanium  Series Box #06", Description = @"ESSS", PhysicalLocation = @"Attic", OName = @"Micro Machines - Titanium  Series Box #06 (ESSS) [Attic]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Micro Machines - Titanium  Series Box #10", Description = @"BSG", PhysicalLocation = @"Attic", OName = @"Micro Machines - Titanium  Series Box #10 (BSG) (SMO) [Attic]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Mounted in NFL Action '72 Album #2", Description = @"", PhysicalLocation = @"", OName = @"Mounted in NFL Action '72 Album #2" },
                new Location { ID = Guid.NewGuid(), Name = @"Mounted in NHL Action Players Album", Description = @"Loblaws", PhysicalLocation = @"", OName = @"Mounted in NHL Action Players Album (Loblaws)" },
                new Location { ID = Guid.NewGuid(), Name = @"Music DVDs Box #1", Description = @"33250", PhysicalLocation = @"Basement", OName = @"Music DVDs Box #1 (33250) [Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"NFL Action '72 Binder", Description = @"", PhysicalLocation = @"", OName = @"NFL Action '72 Binder" },
                new Location { ID = Guid.NewGuid(), Name = @"Office", Description = @"", PhysicalLocation = @"", OName = @"Office" },
                new Location { ID = Guid.NewGuid(), Name = @"On Order - Canceled", Description = @"", PhysicalLocation = @"", OName = @"On Order - Canceled" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Plano Card Storage Case", Description = @"", PhysicalLocation = @"Ken's Room", OName = @"Plano Card Storage Case [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Pre-Order", Description = @"", PhysicalLocation = @"", OName = @"Pre-Order" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Queued", Description = @"", PhysicalLocation = @"", OName = @"Queued" },
                new Location { ID = Guid.NewGuid(), Name = @"Ready to install", Description = @"", PhysicalLocation = @"", OName = @"Ready to install" },
                new Location { ID = Guid.NewGuid(), Name = @"Resin Box #01", Description = @"UHM", PhysicalLocation = @"Upstairs Hallway", OName = @"Resin Box #01 (UHM)[Upstairs Hallway]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"SciFi Box #8", Description = @"WML", PhysicalLocation = @"Basement", OName = @"SciFi Box #8 (WML) [Basement]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Stamp Storage Case", Description = @"", PhysicalLocation = @"Ken's Room", OName = @"Stamp Storage Case [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Stamp Storage Case", Description = @"Unbursted - Cowboys", PhysicalLocation = @"Ken's Room", OName = @"Stamp Storage Case (Unbursted - Cowboys) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Stamp Storage Case", Description = @"Unbursted - Dolphins", PhysicalLocation = @"Ken's Room", OName = @"Stamp Storage Case (Unbursted - Dolphins) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Stamp Storage Case", Description = @"Unbursted - Eagles", PhysicalLocation = @"Ken's Room", OName = @"Stamp Storage Case (Unbursted - Eagles) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Stamp Storage Case", Description = @"Unbursted - Jets", PhysicalLocation = @"Ken's Room", OName = @"Stamp Storage Case (Unbursted - Jets) [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Star Trek Attack Wing Case #01", Description = @"Plano 993179", PhysicalLocation = @"", OName = @"Star Trek Attack Wing Case #01 (Plano 993179)" },
                new Location { ID = Guid.NewGuid(), Name = @"Star Trek Attack Wing Case #02", Description = @"Plano 993179", PhysicalLocation = @"", OName = @"Star Trek Attack Wing Case #02 (Plano 993179)" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Star Wars X-Wing Box #2", Description = @"Unmarked 12x16x4.25", PhysicalLocation = @"Ken's Room", OName = @"Star Wars X-Wing Box #2 (Unmarked 12x16x4.25) [Ken's Room]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Topps 1972 Football Series 1 & 2", Description = @"", PhysicalLocation = @"Ken's Room", OName = @"Topps 1972 Football Series 1 & 2 [Ken's Room]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps 2006 Football #1", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps 2006 Football #1 [Football Cards Box #1 (ESSS) [Closet]]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps 2006 Football #2", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps 2006 Football #2 [Football Cards Box #1 (ESSS) [Closet]]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps 2006 Football #3", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps 2006 Football #3 [Football Cards Box #1 (ESSS) [Closet]]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps 2007 Football Complete Set Box", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps 2007 Football Complete Set Box [Football Cards Box #1 (ESSS) [Closet]]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps 2008 Football #1", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps 2008 Football #1 [Football Cards Box #1 (ESSS) [Closet]]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps 2008 Football Complete Set Box", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps 2008 Football Complete Set Box [Football Cards Box #1 (ESSS) [Closet]]" },
                new Location { ID = Guid.NewGuid(), Name = @"Topps Cowboys Box #01", Description = @"ESSS", PhysicalLocation = @"Football Cards Box #1 (ESSS) [Closet", OName = @"Topps Cowboys Box #01 [Football Cards Box #1 (ESSS) [Closet]]" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Undecided", Description = @"Carol", PhysicalLocation = @"", OName = @"Undecided (Carol)" },
                ...
                new Location { ID = Guid.NewGuid(), Name = @"Wire Rack", Description = @"Top Shelf", PhysicalLocation = @"Ken's Room - East Wall", OName = @"Wire Rack (Top Shelf) [Ken's Room - East Wall]" },
