namespace TC3EF6.Data.Migrations
{
    using System;
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Artist = c.String(maxLength: 80,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Album artist - Artist under which the album was released (not necessarily each track's artist).")
                                },
                            }),
                        ArtistID = c.Guid(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Album artist (ID) - Artist under which the album was released (not necessarily each track's artist).")
                                },
                            }),
                ...
                .Index(t => new { t.AlphaSort, t.MediaFormat, t.ID }, unique: true, name: "IX_AlbumsByAlphaSort")
                .Index(t => new { t.Artist, t.Year, t.MediaFormat, t.ID }, unique: true, name: "IX_AlbumsByArtist")
                .Index(t => new { t.MediaFormat, t.Artist, t.Year, t.ID }, unique: true, name: "IX_AlbumsByFormat")
                .Index(t => new { t.Type, t.Artist, t.Year, t.MediaFormat, t.ID }, unique: true, name: "IX_AlbumsByType")
                ...
                c => new
                    {
                        ...
                        OName = c.String(maxLength: 80,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Original Location field from source database (TODO: Remove after conversion).")
                                },
                            }),
                        OID = c.Int(
                            annotations: new Dictionary<string, AnnotationValues>
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        AKA = c.String(maxLength: 32,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Alternate artist name string (Also Known As).")
                                },
                            }),
                        Comments = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Artist Comments.")
                                },
                            }),
                        AlphaSort = c.String(nullable: false, maxLength: 256,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                        ...
                        Name = c.String(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Artist Name.")
                                },
                            }),
                        OID = c.Int(
                            annotations: new Dictionary<string, AnnotationValues>
                ...
                .PrimaryKey(t => t.ID)
                .Index(t => new { t.AlphaSort, t.ID }, unique: true, name: "IX_ArtistsByAlphaSort");
                ...
                c => new
                    {
                        ...
                        Type = c.String(maxLength: 132,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Type of Item (i.e. Aircraft, Ship, Tool, etc.).")
                                },
                            }),
                        Cataloged = c.Boolean(
                            annotations: new Dictionary<string, AnnotationValues>
                ...
                c => new
                    {
                        ...
                        SourceTable = c.String(maxLength: 80,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Source Table for this Video (TODO: Remove after conversion).")
                                },
                            }),
                        Cataloged = c.Boolean(
                            annotations: new Dictionary<string, AnnotationValues>
                ...
                c => new
                    {
                        ...
                        Milestone = c.String(maxLength: 256,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "String briefly describing the action being reported.")
                                },
                            }),
                        Message = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "String describing more detail regarding the action taken.")
                                },
                            }),
                        StartTime = c.DateTime(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Start Time of a timed action.")
                                },
                                { 
                                    "SqlDefaultValue",
                                    new AnnotationValues(oldValue: null, newValue: "getdate()")
                        ...
                        FinishTime = c.DateTime(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Finish Time of a timed action.")
                                },
                            }),
                        EffectiveDate = c.DateTime(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Effective date-time of the reported action.")
                                },
                                { 
                                    "SqlDefaultValue",
                                    new AnnotationValues(oldValue: null, newValue: "getdate()")
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        Genre = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Genre name for this track (if any)")
                                },
                            }),
                        AlbumArtist = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Album artist name - (temporary until post-conversion)")
                                },
                            }),
                        AlbumArtistID = c.Guid(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Album artist reference (ID)")
                                },
                            }),
                        Artist = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Artist name - (temporary until post-conversion)")
                                },
                            }),
                        ArtistID = c.Guid(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Track artist reference (ID) - (if known)")
                                },
                            }),
                        Year = c.Int(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Year track was written/published - (if known)")
                                },
                            }),
                        Album = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Album name - (temporary until post-conversion)")
                                },
                            }),
                        AlbumID = c.Guid(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Album reference (ID)")
                                },
                            }),
                        DiscNumber = c.Int(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Disc number (if known)")
                                },
                            }),
                        TrackNumber = c.Int(nullable: false,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Track number")
                                },
                            }),
                        Title = c.String(nullable: false, maxLength: 256,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Track Title/Name")
                                },
                            }),
                        Duration = c.Decimal(nullable: false, storeType: "money",
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Track length in seconds")
                                },
                            }),
                        Composer = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Composer (if known)")
                                },
                            }),
                        Comment = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Comment (if any)")
                                },
                            }),
                        Path = c.String(maxLength: 512,
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Path of the Track (MP3/MP4) in file system (if appropriate).")
                                },
                            }),
                        Lyrics = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Lyrics (if known)")
                                },
                            }),
                        Publisher = c.String(
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                                    "ColumnDescription",
                                    new AnnotationValues(oldValue: null, newValue: "Publisher Name (if known).")
                                },
                            }),
                        OID = c.Int(
                            annotations: new Dictionary<string, AnnotationValues>
                ...
                .PrimaryKey(t => t.ID)
                .Index(t => new { t.AlbumID, t.Year, t.DiscNumber, t.TrackNumber, t.Title, t.ID }, unique: true, name: "IX_TracksByAlbum")
                .Index(t => new { t.ArtistID, t.Year, t.DiscNumber, t.TrackNumber, t.Title, t.ID }, unique: true, name: "IX_TracksByArtist");
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Albums", "LocationID", "dbo.Locations");
            ...
            DropIndex("dbo.Tracks", "IX_TracksByArtist");
            DropIndex("dbo.Tracks", "IX_TracksByAlbum");
            ...
            DropIndex("dbo.Artists", "IX_ArtistsByAlphaSort");
            DropIndex("dbo.Albums", new[] { "LocationID" });
            DropIndex("dbo.Albums", "IX_AlbumsByType");
            DropIndex("dbo.Albums", "IX_AlbumsByFormat");
            ...
            DropTable("dbo.Tracks",
                ...
                removedColumnAnnotations: new Dictionary<string, IDictionary<string, object>>
                {
                    ...
                    },
                    {
                        ...
                        new Dictionary<string, object>
                        {
                            { "ColumnDescription", "Year track was written/published - (if known)" },
                        }
                    },
                });
            DropTable("dbo.Tools",
